...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Nice', 0.7], //69%
		['Perfect', 0.8], //From 70% to 79%
		['Zamn', 0.9], //From 80% to 89%
		['Sheeeeesh!', 1], //From 90% to 99%
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			case 'tutorial':
				credits = 'How to funk';
			case 'bopeebo':
				credits = 'She Calls Me Daddy Too';
			case 'fresh':
				credits = 'She Calls Me Daddy Too';
			case 'dadbattle':
				credits = "She Calls Me Daddy Too";
			case 'spookeez' :
				credits = 'No More Tricks';
			case 'south':
				credits = 'No More Tricks';
			case 'monster':
				credits = 'I will eat your GF';
			case 'pico':
				credits = 'Call Me The Hitman';
			case 'philly':
				credits = 'Call Me The Hitman';
			case 'blammed':
				credits = 'Call Me The Hitman';
			...
			case 'milf':
				credits = 'Lady Killer';
			case 'cocoa':
			    credits = 'Missless Christmas';
			case 'eggnog':
				credits = 'Missless Christmas';
			case 'winter-horrorland':
				credits = 'Deathly Christmas';
			case 'senpai':
				credits = 'Come on ladys!';
			case 'roses':
				credits = 'Do you like roses?!';
			case 'thorns':
				credits = 'Highscore!!';
			default:
				credits = '';
